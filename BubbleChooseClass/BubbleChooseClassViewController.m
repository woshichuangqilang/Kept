...
-(void)changeView:(id)sender{
    XZTableViewController *classPicker = [[XZTableViewController alloc]init];
    UINavigationController *nav = [[UINavigationController alloc]initWithRootViewController:classPicker];
